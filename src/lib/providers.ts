...
export const PROVIDERS: Provider[] = [
  ...
  { id: 'lovable', name: 'Lovable', path: '/variants/lovable/index.html', noindex: true, icon: '♥', logo: '/logos/lovable.svg', color: '#ff006e' },
  { id: 'bolt', name: 'Bolt', path: '/variants/bolt/index.html', noindex: true, icon: '⚡', logo: '/logos/bolt.svg', color: '#f59e0b' },
  ...
  { id: 'v0', name: 'v0', path: '/variants/v0/index.html', noindex: true, icon: 'v0', logo: '/logos/v0.svg', color: '#000' }
];